        ...
        <tbody>
          {portfolios.map((portfolio) => (
            <tr key={portfolio._id} className="text-center border">
              <td className="border p-2">{portfolio.URI}</td>
      ...
      {selectedPortfolio && (
        <div className="fixed inset-0 bg-gray-800 bg-opacity-50 flex justify-center items-center">
          <div className="bg-white p-6 rounded shadow-lg w-1/3">
            <h3 className="text-lg font-bold mb-4">Edit Portfolio URI</h3>
            <input
              type="text"
              value={updatedURI}
            ...
            <div className="flex justify-end mt-4 gap-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#6878d6] hover:bg-blue-800 text-white rounded"
              >
                Update
              </button>
            </div>
