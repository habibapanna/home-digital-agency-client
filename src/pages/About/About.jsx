  ...
  return (
    <div className="bg-[#eff2ff]">
      ...
      <div className="pt-96 md:pt-56">
        ...
        <p className='text-gray-700 text-sm md:text-lg'>Etiam erat lectus, finibus eget commodo quis, tincidunt eget leo. Nullam quis vulputate orci, ac accumsan quam. Morbi fringilla congue libero.
        1-800-1234-567</p>
            </div>
            <div className=''>
